/*SEQUENCE and OR on Join is not working */
...
INSERT INTO TABLE SCD.CUSTOMER VALUES('104','Nantha','Kumar','1977-01-01','42','Karavalasu','Erode','India','631 312',1234) ;
INSERT INTO TABLE SCD.CUSTOMER VALUES('105','Raj','Veerappan','1977-01-01','42','Solent Road','Portsmouth','UK','PO6 1HJ',5678) ;
INSERT INTO TABLE SCD.CUSTOMER VALUES('106','Kanna','Natarsan','1977-01-01','42','Karavalasu','Erode','India','631 312',1234) ;
INSERT INTO TABLE SCD.CUSTOMER VALUES('107','Muthu','Krishnan','1977-01-01','42','Solent Road','Portsmouth','UK','PO6 1HJ',5678) ;
INSERT INTO TABLE SCD.CUSTOMER VALUES('108','Nantha','Kumar','1977-01-01','42','Karavalasu','Erode','India','631 312',1234) ;
