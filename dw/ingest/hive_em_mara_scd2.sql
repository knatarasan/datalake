...
#Seems UDF is running on different mappers, so producing duplicate surrogate keys
...
/*
Things are working fine with above logic, except:  
    incr() an udf which runs individually on different mappers eventually creates duplicate surrogate key
